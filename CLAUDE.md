...
> Last updated: session 21 (Phone links everywhere; PDF/image add in documents; service stages bottom sheet from dashboard; stage status: Rejected=terminal; simultaneous active+archive on dashboard; Android image zoom via WebView; stage city inline in edit modal; scanner drag-handle crop UI; expo-document-picker added)
