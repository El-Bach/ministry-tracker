...
> Last updated: session 37 (Multi-tenant isolation hardening; nested-ScrollView fixes; modal-position flips; per-stage city + assignee inline create; UX polish across stage pickers)
