...
export default function CreateScreen() {
  ...
  return (
    <SafeAreaView style={s.safe} edges={['top', 'bottom']}>
      ...
      {/* ── NETWORK MODAL ── */}
      <Modal visible={manageSection === 'network'} transparent animationType="fade" onRequestClose={() => { setManageSection(null); setShowNetworkForm(false); setShowImportModal(false); }}>
        <View style={s.modalOverlay}>
